# Generated by Django 4.0.5 on 2022-06-25 01:27
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='nave',
            name='Id_D',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='model.cliente', verbose_name='ID Dueño'),
        ),
        migrations.AddField(
            model_name='nave',
            name='Id_Plazas',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='model.plazas', verbose_name='ID Plazas'),
        ),
        migrations.AddField(
            model_name='instalacion',
            name='Id_A',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='model.aeropuerto', verbose_name='ID Aeropuerto'),
        ),
        migrations.AddField(
            model_name='arribo',
            name='Id_C',
