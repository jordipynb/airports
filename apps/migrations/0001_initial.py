# Generated by Django 4.0.5 on 2022-06-22 01:06
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Clasific', models.CharField(max_length=40, verbose_name='Clasificacion')),
                ('No_Trip', models.SmallIntegerField(verbose_name='No. Tripulantes')),
                ('Capacidad', models.SmallIntegerField(verbose_name='Capacidad')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Id_I', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.instalacion', verbose_name='ID Instalacion')),
            ],
        ),
        migrations.CreateModel(
            name='Vuelo',
            fields=[
                ...
                ('Id_A', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.aeropuerto', verbose_name='ID Aeropuerto')),
                ('No_Mat', models.ForeignKey(max_length=30, on_delete=django.db.models.deletion.CASCADE, to='apps.nave', verbose_name='No. Matricula')),
            ],
        ),
        migrations.CreateModel(
            name='Valoracion',
            fields=[
                ...
                ('Id_Ar', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.arribo', verbose_name='ID Arribo')),
                ('Id_S', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.servicio', verbose_name='ID Servicio')),
            ],
        ),
        migrations.CreateModel(
            name='ReparaNave',
            fields=[
                ...
                ('Id_Rep', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.reparacion', verbose_name='ID Reparacion')),
                ('Id_V', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.vuelo', verbose_name='ID Vuelo')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Id_Rep', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reparacion', to='apps.reparacion', verbose_name='ID Reparacion')),
                ('Id_RepDep', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dependiente', to='apps.reparacion', verbose_name='ID Reparacion Dep')),
            ],
        ),
        migrations.AddField(
            model_name='reparacion',
            name='Id_S',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.servicio', verbose_name='ID Servicio'),
        ),
        migrations.AddConstraint(
            model_name='plazas',
            constraint=models.UniqueConstraint(fields=('Clasific', 'No_Trip', 'Capacidad'), name='Id de Plazas'),
        ),
        migrations.AddField(
            model_name='nave',
            name='Id_D',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.cliente', verbose_name='ID Dueño'),
        ),
        migrations.AddField(
            model_name='nave',
            name='Id_Plazas',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.plazas', verbose_name='ID Plazas'),
        ),
        migrations.AddField(
            model_name='instalacion',
            name='Id_A',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.aeropuerto', verbose_name='ID Aeropuerto'),
        ),
        migrations.AddField(
            model_name='arribo',
            name='Id_C',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.cliente', verbose_name='ID Cliente'),
        ),
        migrations.AddField(
            model_name='arribo',
            name='Id_V',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.vuelo', verbose_name='ID Vuelo'),
        ),
        migrations.AddConstraint(
            model_name='vuelo',
